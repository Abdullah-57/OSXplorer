...
import { Github, Linkedin, Twitter, Mail, ExternalLink, BookOpen, Code, Gamepad2 } from "lucide-react"
...
export function Footer() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      avatar: "/placeholder.svg?height=40&width=40",
      social: {
        github: "https://github.com/marcuskim",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="flex flex-col">
            ...
            {teamMembers.map((member, index) => (
              <div
                key={index}
                  className="bg-gray-900/50 rounded-lg p-2 border border-gray-700/50 hover:border-cyan-500/30 transition-all duration-300 group min-h-[60px]" // reduced padding and min height
              >
                  <div className="flex items-center space-x-2 mb-2"> {/* reduced spacing */}
                  <div
                      className={`w-8 h-8 rounded-full bg-gradient-to-r ${member.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`} // reduced avatar size
                  >
                  ...
                  <div className="flex space-x-1"> {/* reduced icon spacing */}
                  <a
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 w-full">
            ...
            <div className="flex items-center space-x-4">
              <a
                href="https://github.com/oslearn-plus"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
          ...
          <div className="w-full text-center text-xs text-gray-500 mt-2">
            © 2025 OSLearn+. All rights reserved. Level up your learning. &nbsp;|&nbsp; Made with ❤️ by the OSLearn+ Team
          </div>
        </div>
      </div>
    </footer>
