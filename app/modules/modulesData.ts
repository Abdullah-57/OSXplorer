  ...
  "cpu-scheduling": {
    ...
    levelSections: [
      // ... FCFS, SJF, SRTF, Priority, Round Robin sections from cpu-scheduling/page.tsx ...
      {
        ...
        levels: [
          { id: "fcfs-l1", title: "Pure FCFS", description: "Basic first-come-first-serve scheduling", difficulty: 2, status: "completed", xpReward: 50 },
  ...
  "memory-management": {
    ...
    levelSections: [
      // ... First Fit, Best Fit, Worst Fit, Paging, Segmentation, Fragmentation sections from memory-management/page.tsx ...
      {
        ...
        levels: [
          { id: "first-fit-l1", title: "Basic Allocation", description: "Simple first-fit memory allocation", difficulty: 2, status: "completed", xpReward: 60, visualType: "blocks" },
  ...
  "process-synchronization": {
    ...
    levelSections: [
      // ... Critical Section, Mutex, Binary Semaphore, Counting Semaphore, Producer-Consumer, Dining Philosophers sections from process-synchronization/page.tsx ...
      {
        ...
        levels: [
          { id: "critical-section-l1", title: "Two Threads", description: "Basic critical section with two threads", difficulty: 2, status: "completed", xpReward: 70, visualType: "critical" },
